<?php
	...
	if (isset($_GET["q"])) {
		...
		write("Track Name", $track);
		write("Artist Name", $artist);
		write("Album Name", $album);
		write("Release Date", $date);
		write("Primary Genre", $genre);
		write("Track No.", $trackno);
		write("MP3 URL", downloadLink($video_id));
